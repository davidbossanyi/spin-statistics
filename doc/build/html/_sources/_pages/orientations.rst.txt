...
Computation of Euler angles and centre-of-mass vectors between the molecules of a triplet-pair can be done using the :class:`spinstats.MolecularOrientation` class. This will require the following steps to be performed in `Mercury <https://www.ccdc.cam.ac.uk/solutions/csd-system/components/mercury/>`_ first:
...
The Euler angles and centre-of-mass vector can then be computed using :class:`spinstats.MolecularOrientation`.
...
.. code-block:: python
   ...
   import pandas as pd
   from spinstats import MolecularOrientation
...
.. autoclass:: spinstats.MolecularOrientation
	:members: